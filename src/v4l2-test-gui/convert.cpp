...
void unpackToRAW8(cv::Mat &unpackedRAW8, const Image &image)
{
...
cv::Mat convert(const Image &image, bool raw)
{
    ...
    case V4L2_PIX_FMT_SRGGB10P: type =  CV_8UC1; debayer = true;  divider = 1023; code =  cv::COLOR_BayerRG2RGB; packed = true; break;
    case V4L2_PIX_FMT_SGBRG10P: type =  CV_8UC1; debayer = true;  divider = 1023; code =  cv::COLOR_BayerGB2RGB; packed = true; break;
    case V4L2_PIX_FMT_SGRBG10P: type =  CV_8UC1; debayer = true;  divider = 1023; code =  cv::COLOR_BayerGR2RGB; packed = true; break;
    case V4L2_PIX_FMT_SBGGR10P: type =  CV_8UC1; debayer = true;  divider = 1023; code =  cv::COLOR_BayerBG2RGB; packed = true; break;
